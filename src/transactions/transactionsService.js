...
export async function getTransactionsTotal(startDate, endDate, categoryType) {
  const response = await api.get(
    `/v1/transactions/total?startDate=${startDate}&endDate=${endDate}&categoryType=${categoryType}`
  );
